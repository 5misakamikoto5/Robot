...
AA = [ ];
for i =1:6
    Tca = T_tran(base_Data(i,4:6),base_Data(i,1:3));
    Tcb = T_tran(penqiang_Data(i,4:6),penqiang_Data(i,1:3));
...
for i =1:440
    T_tmp = T_tran(demonstrations_data(i,4:6),demonstrations_data(i,1:3));
